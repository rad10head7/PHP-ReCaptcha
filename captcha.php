...
function secure_generate_string($input, $strength = 5, $secure = true) {
  ...
  $fonts = [dirname(__FILE__).'/fonts/Acme-Regular.ttf', dirname(__FILE__).'/fonts/Ubuntu-MediumItalic.ttf', dirname(__FILE__).'/fonts/Merriweather-Bold.ttf', dirname(__FILE__).'/fonts/PlayfairDisplay-Regular.ttf', dirname(__FILE__).'/fonts/Roboto-Regular.ttf'];
